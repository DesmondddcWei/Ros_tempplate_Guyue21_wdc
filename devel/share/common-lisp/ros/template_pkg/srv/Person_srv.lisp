...
(cl:in-package template_pkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Person_srv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person_srv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name template_pkg-srv:<Person_srv-request> is deprecated: use template_pkg-srv:Person_srv-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader template_pkg-srv:name-val is deprecated.  Use template_pkg-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader template_pkg-srv:age-val is deprecated.  Use template_pkg-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <Person_srv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader template_pkg-srv:sex-val is deprecated.  Use template_pkg-srv:sex instead.")
  (sex m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Person_srv-request>)))
  ...
  "template_pkg/Person_srvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Person_srv-request)))
  "Returns string type for a service object of type 'Person_srv-request"
  "template_pkg/Person_srvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Person_srv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person_srv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name template_pkg-srv:<Person_srv-response> is deprecated: use template_pkg-srv:Person_srv-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Person_srv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader template_pkg-srv:result-val is deprecated.  Use template_pkg-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Person_srv-response>)))
  ...
  "template_pkg/Person_srvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Person_srv-response)))
  "Returns string type for a service object of type 'Person_srv-response"
  "template_pkg/Person_srvResponse")
